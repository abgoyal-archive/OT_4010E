...
#  Copyright Statement:
#  ---------------------------
#  This software/firmware and related documentation (Â¡Â§MediaTek SoftwareÂ¡Â¨) are
...
#  THERETO. RECEIVER EXPRESSLY ACKNOWLEDGES THAT IT IS RECEIVERÂ¡Â¦S SOLE
...
# Generated at Thu Aug 23 11:37:08 2012
...
BOARD_VER         = JRDHZ75_GB2_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        = JRDHZ75_GB2_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
CUSTOM_OPTION += __EPSK_TX_SW_SWITCH_OFF__    # add by yinzhanyong for switch off EPSK
...
# ========================================================================
#    Compile Parameter  for customer (Added by jinming.xiang)
# ========================================================================

PRODUCT_IMEI_INFO = FALSE

                    # TRUE: support product info(customization), IMEI in Traceability Zone
                    # FALSE: don't support product info(customization)
					
IMEI_MAGIC_SUPPORT = FALSE

                    # please check the requirement
                    # TRUE: support imei magic(55,55,55,55,55,55,55,58), IMEI in Traceability Zone
                    # FALSE: don't support imei magic, IMEI in OTP 

PRODUCT_AMR_WB_SUPPORT = TRUE
                   
                    # TRUE: support report information
                    # FALSE: Don't support  report information
...
# *************************************************************************
COM_DEFS_FOR_CUSTOM_MT6162 = MT6162_RF CUSTOM_MT6162 CUSTOM_MT6162
...
CUSTOM_OPTION += __SP_GEMINI_3G_SWITCH__ __SMSAL_MSG_WAIT_STORE_BY_AP__
...
COM_DEFS_FOR_JRDHZ75_GB2_LCM = JRDHZ75_GB2_LCM
